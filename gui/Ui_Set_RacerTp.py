...
class Ui_Set_RacerTp(object):
    def setupUi(self, Set_RacerTp):
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(Set_RacerTp)
        self.buttonBox.setGeometry(QtCore.QRect(320, 10, 81, 301))
        ...
        self.buttonBox.accepted.connect(Set_RacerTp.accept)
        self.buttonBox.rejected.connect(Set_RacerTp.reject)
